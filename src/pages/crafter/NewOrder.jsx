                                ...
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 mb-4">
                                            ...
                                            <div className="w-full sm:w-48 flex-shrink-0 relative rounded-xl border-2 border-indigo-100 overflow-hidden shadow-sm aspect-[3/4] bg-gray-100 flex items-center justify-center">
                                                <div className="absolute inset-0 bg-gray-200 animate-pulse flex flex-col items-center justify-center z-0">
                                                    <svg className="w-8 h-8 text-gray-400 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                                ...
                                                />
                                                <div className="absolute top-2 right-2 bg-black/60 backdrop-blur-sm rounded text-white text-[10px] font-bold px-2 py-0.5 tracking-wider uppercase z-20">
                                                    Preview
                                                </div>
                                            </div>
                                        </div>
