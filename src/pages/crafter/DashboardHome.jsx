        ...
        <div className="space-y-6 sm:space-y-8 pb-8">
            ...
            <div className="grid grid-cols-1 min-[400px]:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                {statCards.map((stat, index) => (
                    <div key={index} className={`animate-reveal delay-${index * 100} relative bg-gradient-to-br from-white to-gray-50/50 rounded-2xl shadow-sm hover:shadow-md border border-gray-100 p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 transform hover:-translate-y-1 transition-all duration-300`}>
            ...
            <div className="mt-2 sm:mt-4 pt-2">
                <h3 className="animate-reveal delay-300 text-lg sm:text-xl font-bold text-gray-900 mb-4 px-1">Quick Actions</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                    <button
                        onClick={() => navigate('/dashboard/new-order')}
                        className="animate-reveal delay-300 relative overflow-hidden flex flex-col items-center justify-center p-6 sm:p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 group w-full transform hover:-translate-y-1 transition-all duration-300"
                    >
                    ...
                    <button
                        ...
                        className="animate-reveal delay-[400ms] relative overflow-hidden flex flex-col items-center justify-center p-6 sm:p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 group w-full transform hover:-translate-y-1 transition-all duration-300"
                    >
                    ...
                    <button
                        ...
                        className="animate-reveal delay-[500ms] relative overflow-hidden flex flex-col items-center justify-center p-6 sm:p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 group w-full transform hover:-translate-y-1 transition-all duration-300"
                    >
